/******************************************************************************
	File		: isl29124.h
        ...
        Description     : Header file for the driver isl29124.c that services the ISL29124
                  	  RGB light sensor
...
#define ISL29124_SYSFS_PERMISSIONS		00666

/************************** PLATFORM DATA *************************************/

 
struct isl29124_platform_data {
	int gpio_irq;
};
